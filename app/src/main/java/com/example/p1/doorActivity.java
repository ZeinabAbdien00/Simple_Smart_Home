...
// TODO Auto-generated method stub
                ...
                if(pass.getText().toString().equals(s_password))
                {
                    try {
                        mBTSocket.getOutputStream().write(ser.getBytes());
                ...
                } else if(pass.getText().toString()!="suzan")
                {
                    Toast.makeText(doorActivity.this, "Enter Correct Password !", Toast.LENGTH_SHORT).show();
                }
            }});
    }
...
// TODO Auto-generated method stub
    ...
    private class ConnectBT extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(doorActivity.this, "Hold on", "Connecting");// http://stackoverflow.com/a/11130220/1287554
